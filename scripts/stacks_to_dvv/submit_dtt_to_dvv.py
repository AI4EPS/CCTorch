...
echo "Running DVV on (node_rank, num_node) = ($NODE_RANK, $NUM_NODES)"
python run_dtt_to_dvv.py --node_rank $NODE_RANK --num_nodes $NUM_NODES --project $PROJECT
""",
    workdir=".",
    num_nodes=1,
    envs={
...
for NODE_RANK in range(NUM_NODES):
    ...
    cluster_name = f"cctorch-dtt2dvv-{NODE_RANK:03d}"
    ...
    print(f"Running dtt_to_dvv on (rank={NODE_RANK}, num_node={NUM_NODES}) of {cluster_name}")
