...
echo "Running Merge CCFs on (node_rank, num_node) = ($NODE_RANK, $NUM_NODES)"
python run_merge_ccf_das.py --file_mark $FILE_MARK --project $PROJECT
""",
    workdir=".",
    num_nodes=1,
    envs={"FILE_MARK": FILE_MARK, "PROJECT": PROJECT},
)
...
for NODE_RANK in range(NUM_NODES):
    ...
    cluster_name = f"cctorch-mergeCCF_das-{FILE_MARK}-{NODE_RANK:03d}"
