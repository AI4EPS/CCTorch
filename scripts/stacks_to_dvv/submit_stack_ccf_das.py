...
echo "Running Stack CCFs on (node_rank, num_node) = ($NODE_RANK, $NUM_NODES)"
python run_stack_ccf_das.py --file_mark $FILE_MARK --project $PROJECT
""",
    workdir=".",
    num_nodes=1,
...
for NODE_RANK in range(NUM_NODES):
    ...
    cluster_name = f"cctorch-stackCCF_das-{FILE_MARK}-{NODE_RANK:03d}"
