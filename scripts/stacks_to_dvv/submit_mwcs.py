...
echo "Running MWCS on (node_rank, num_node) = ($NODE_RANK, $NUM_NODES)"
python run_mwcs.py --node_rank $NODE_RANK --num_nodes $NUM_NODES --project $PROJECT
""",
    workdir=".",
    num_nodes=1,
    envs={
...
for NODE_RANK in range(NUM_NODES):
    ...
    cluster_name = f"cctorch-mwcs-{NODE_RANK:03d}"
